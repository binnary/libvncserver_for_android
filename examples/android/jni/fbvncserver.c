...
static void init_fb_server(int argc, char **argv)
{
    ...
    vncscr->colourMap.is16=FALSE;
    vncscr->colourMap.count=2;
    vncscr->colourMap.data.bytes=(unsigned char*)"\xd0\xd0\xd0\x30\x01\xe0";
	...
	varblock.r_offset = scrinfo.red.offset + scrinfo.red.length;
	varblock.g_offset = scrinfo.green.offset + scrinfo.green.length;
	varblock.b_offset = scrinfo.blue.offset + scrinfo.blue.length;
...
static void update_screen(void)
{
	...
	varblock.min_i = varblock.min_j = 99999999;
    ...
    memcpy(vncbuf, fbmmap, ((scrinfo.xres * scrinfo.yres/8)*scrinfo.bits_per_pixel));
